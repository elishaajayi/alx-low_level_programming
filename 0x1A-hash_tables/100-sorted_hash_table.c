 ...
 * Return: If an error occurs - NULL otherwise new sorted hash table.
 */
...
int shash_table_set(shash_table_t *ht, const char *key, const char *value)
{
	...
	ht->array[index] = new;
	return (shash_table_set_sorted(ht, new));
}

/**
 * shash_table_get - value associated with a key in a sorted hash table.
 * @ht: A pointer to the sorted hash table.
...
/**
 * shash_table_set_sorted - Inserts a node into the sorted linked list
 * @ht: A pointer to the sorted hash table.
